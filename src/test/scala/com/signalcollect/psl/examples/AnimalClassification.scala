...
//
//  val config = InferencerConfig(isBounded = true, lazyInferencing = false, breezeOptimizer = false, absoluteEpsilon = 10e-08, relativeEpsilon = 10e-03, computeObjectiveValueOfSolution = true)  
